...
function getAIResponse(question: string, riskLevel: string, glucoseAvg: number, pdfContent?: string, patientInfo?: any): string {
...
export default function ChatPage() {
  ...
  useEffect(() => {
    setMounted(true)
    const welcomeMessage = scanResult && patientInfo
      ...
      : `Hello! I'm your AI Health Consultant powered by advanced language models. I have access to ${
          scanResult ? "your scan results" : "general health knowledge"
  ...
  const sendMessage = useCallback(
    async (text: string) => {
      ...
      const aiResponse = getAIResponse(text, riskLevel, glucoseAvg, pdfContent, patientInfo)
      const aiMsg: Message = {
